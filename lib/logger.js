...
(function() {
  var addTransport, contains, croak, debug, disable, enable, error, isTransportValid, logKeys, logLevel, logLevels, removeTransport, scream, setKeys, setLevel, speech, talk, transports, verbosityLevels, warn, whisper, _error, _log, _warn,
    __slice = [].slice;
